...
The `webspace` shortcut rebuilds the generated page and opens:
...
Dark mode keeps its existing family cycling behavior on refresh. Light and mid map to their current single approved themes.
