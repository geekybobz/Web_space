...
function startTypewriter() {
    ...
    if (!el) return;
    _twRunning = true;
    const phrases = (el.dataset.phrases || 'Physicist by obsession||Control engineer by necessity||ML researcher by curiosity||Quantum babysitter by reputation').split('||');
